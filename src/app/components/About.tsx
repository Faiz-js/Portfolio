  ...
  return (
    <section id="about" className="py-4">
      ...
      <AboutCompo>
        ...
        <AboutCompo.Paragraph>
          Explored backend development using ExpressJS and NextJS frameworks,
          which helped me understand server-side concepts and API development.
        </AboutCompo.Paragraph>
      </AboutCompo>
      ...
      <AboutCompo>
        ...
        <AboutCompo.Paragraph>
          During lockdown(2020) I noticed the rise and advancement in technology so I
      ...
      <AboutCompo>
        ...
        <AboutCompo.Paragraph>
          Completed my 12th standard with 69% from the science stream.
        </AboutCompo.Paragraph>
      </AboutCompo>
      ...
      <AboutCompo>
        ...
        <AboutCompo.Paragraph>
          Completed my 10th standard from Holy Trinity Secondary and Higher
          Secondary School, Daman with 67.81%.
        </AboutCompo.Paragraph>
      </AboutCompo>
    </section>
  );
